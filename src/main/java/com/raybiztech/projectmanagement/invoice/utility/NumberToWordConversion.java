...
public class NumberToWordConversion {
	...
	private static String[] maxs = { "", "", " Hundred", " Thousand", " Lakhs",
			" Crore" };

	public NumberToWordConversion() {
		amount = "";
	}
	...
	/*
	 * public static void main(String[] args) { NumberToWordConversion obj=new
	 * NumberToWordConversion(); obj.input();
