...
//
//    @Test
//    public void applyForJobVacancyForCandidate() {
//        JobVacancy jobVacancy = new JobVacancy();
//        jobVacancy.setNoOfRequirements(2);
//        Candidate candidate = new Candidate();
//        candidate.applyForJobVacancy(jobVacancy);
//        Assert.assertEquals(candidate.getAppliedFor(), jobVacancy);
//    }
//
//    @Test(expected = NoJobVacancyException.class)
//    public void applyForJobVacancyForCandidate_WhenNoJobs() {
//        JobVacancy jobVacancy = new JobVacancy();
//        jobVacancy.setNoOfRequirements(0);
//        Candidate candidate = new Candidate();
//        candidate.applyForJobVacancy(jobVacancy);
//
//    }
...
//        jobPortalServiceImpl.setCandidateBuilder(candidateBuilder);
//        Mockito.when(dao.get(Candidate.class)).thenReturn(candidateList);
////        List<CandidateDTO> candidateDTOList = jobPortalServiceImpl.getAllnonScheduledCadidates();
//       // Assert.assertEquals(candidateDTOs.size(), candidateDTOList.size());
//    }
//
//    @Test
...
//        
//        builder.setDesignationKrasBuilder(designationKrasBuilder);
//        designationKrasBuilder.setKraBuilder(kraBuilder);
//        kraBuilder.setKpiBuilder(kpiBuilder);
//        kpiBuilder.setKpiRatingBuilder(kpiRatingBuilder);
//        
//        Employee employee = new Employee();
//        employee.setEmployeeId(1225l);
//        employee.setFirstName("Sairam");
//
//        EmployeeDTO employeeDTO = new EmployeeDTO();
//        employeeDTO.setId(1225l);
//        employeeDTO.setFirstName("Sairam");
//
//        JobPortalServiceImpl jobPortalServiceImpl = new JobPortalServiceImpl();
//        jobPortalServiceImpl.setEmployeeBuilder(builder);
//        DAO dao = Mockito.mock(DAO.class);
//        jobPortalServiceImpl.setDao(dao);
//
//        Mockito.when(dao.findBy(Employee.class, 1225l)).thenReturn(employee);
//
//        EmployeeDTO employeeDTO1 = jobPortalServiceImpl.getEmployee(1225l);
//
//        Assert.assertEquals(employeeDTO.getFirstName(), employeeDTO1.getFirstName());
//
//    }*/
//
//}
